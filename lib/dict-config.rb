...
$dict_info = {
  'cs' => {'type' => 'write', 'label'=>'Czech', 'target'=>'czj', 'pos'=>pos_write, 'stylpriznak'=>stylpriznak_write},
  ...
  'sj' => {'type' => 'write', 'label'=>'Slovak', 'target'=>'spj', 'pos'=>pos_write, 'stylpriznak'=>stylpriznak_write},
  'spj' => {'type' => 'sign', 'label'=>'SPJ', 'search_in'=>'sj', 'target'=>'sj', 'pos'=>pos_sign, 'stylpriznak'=>stylpriznak_sign},
  'de' => {'type' => 'write', 'label'=>'German', 'target'=>'ogs', 'pos'=>pos_write, 'stylpriznak'=>stylpriznak_write},
  'ogs' => {'type' => 'sign', 'label'=>'OGS', 'search_in'=>'de', 'target'=>'de', 'pos'=>pos_sign, 'stylpriznak'=>stylpriznak_sign},
  'uk' => {'type' => 'write', 'label'=>'Ukrainian', 'target'=>'uzm', 'pos'=>pos_write, 'stylpriznak'=>stylpriznak_write},
  'uzm' => {'type' => 'sign', 'label'=>'UZM', 'search_in'=>'uk', 'target'=>'uk', 'pos'=>pos_sign, 'stylpriznak'=>stylpriznak_sign},
}
$fsw_style = '-CG_white_'
